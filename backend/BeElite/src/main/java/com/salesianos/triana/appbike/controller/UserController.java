...
import com.salesianos.triana.appbike.service.AthleteService;
...
public class UserController {
        ...
        public ResponseEntity<JwtUserResponse> createCoach(@Valid @RequestBody AddUser addCoach) {
        ...
        public ResponseEntity<JwtUserResponse> createAthlete(@Valid @RequestBody AddUser addAthlete) {
                Athlete athlete = athleteService.createUser(addAthlete);
        ...
        @Operation(summary = "Login athlete")
        @ApiResponses(value = {
        ...
        public ResponseEntity<JwtUserResponse> athleteLogin(@RequestBody LoginUser loginAthlete) {

                Authentication authentication = authManager.authenticate(
                        new UsernamePasswordAuthenticationToken(
                                loginAthlete.username(),
                                loginAthlete.password()));
                SecurityContextHolder.getContext().setAuthentication(authentication);
                String token = jwtProvider.generateToken(authentication);
        ...
        @PostMapping("/auth/login/coach")
        public ResponseEntity<JwtUserResponse> coachLogin(@RequestBody LoginUser loginCoach) {
