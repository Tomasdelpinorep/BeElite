...
class SaveEditedSessionEvent extends SessionEvent{
  ...
  final String programName;
  final String coachUsername;
  SaveEditedSessionEvent(this.newSession, this.weekName, this.weekNumber, this.programName, this.coachUsername);
}
...
class DeleteSessionEvent extends SessionEvent{
  ...
  final int weekNumber;
  final int sessionNumber;
  DeleteSessionEvent(this.coachUsername, this.weekName, this.programName, this.weekNumber, this.sessionNumber);
}
