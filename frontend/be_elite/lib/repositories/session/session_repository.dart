...
abstract class SessionRepository {
  ...
  Future<PostSessionDto> getPostSessionDto(String coachUsername,
      String programName, String weekName, int weekNumber, int sessionNumber);

  Future<void> deleteSession(String coachUsername, String programName,
      String weekName, int weekNumber, int sessionNumber);
}
